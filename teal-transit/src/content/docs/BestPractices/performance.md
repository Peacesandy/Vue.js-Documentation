...
1. Consult Ways of Using Vue to see how you can leverage Vue in different ways.

2. Jason Miller discusses the types of web applications and their respective ideal implementation / delivery in Application Holotypes.
